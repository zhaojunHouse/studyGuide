...
# 计算机专业课程
* [计算机专业学生一定要学好这几门课](https://www.jianshu.com/p/ab20dc455132)
* [如何自学计算机专业课程](https://www.jianshu.com/p/72512b2fcab9)
* [计算机专业课](https://zhidao.baidu.com/question/424878990821834812.html)
...
####  10.2 设计工业级散列表
* 1. hash函数设计
* 2. hash表初始大小，动态扩容，高效扩容先扩容，然后等插入数据时再拷贝数据到新的散列表
* 3. 散列冲突链表法可以用红黑树替代；
